...
// creating boundaries where 9873(value for collision) exist
...
console.log("logging collision boundaries below");
console.log(boundaries);
console.log("logging  interaction boundaries below");
console.log(interactionBoundaries);

const image = new Image()
image.src = 'static/socialnetwork/image/myRoom.png'
